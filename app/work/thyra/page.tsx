...
export default function ThyraPage() {
  return <WorkDocument category="HEALTHCARE & SERVICE DESIGN" title="Thyra" subtitle="Patient-centered I-131 Care"
    description={<><p>以患者为中心的甲状腺癌 I-131 治疗服务优化设计</p><p className="work-partner">美国明尼苏达大学医学院合作项目 / University of Minnesota Medical School</p><p>梳理中美就医路径与关键服务断点，协同设计 AI 健康助手，将个性化治疗时间线、健康教育与日常决策支持连接起来。</p></>}>
    ...
    <WorkSection number="04" title="Core Interactions">
      ...
      <WorkFigure src={base+'diet-assistant.webp'} alt="Diet assistant conversation flowing from a food question to a food log" caption="FIG. 05 / 低碘饮食助手：提问、逐步确认与记录。" />
