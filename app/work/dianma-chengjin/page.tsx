...
export default function DianmaChengjinPage() {
  return <WorkDocument category="AI PRODUCT / AGENT DESIGN" title="点马成金" subtitle="AI 能力识别与转行规划系统"
    description={<><p className="work-award-line">腾讯云 · TT 设计学院 Skill 创新应用大赛 · <span>第六名 / Ranked 6th</span></p><p>面向准备转向交互设计、产品体验与服务设计的设计学生，将课程、竞赛与实习经历转译为目标岗位能够识别的能力证据。</p><p>系统先判断方向与已有积累，再完成能力识别、缺口诊断、岗位匹配和策略驱动的作品集规划。</p></>}>
