...
const freeExploreHotspots: HotspotData[] = [
  ...
  { id: 'free-documents', label: 'DOCUMENTS', entry: 'internship', details: ['Internship', 'Professional experience'], x: 83, y: 70, align: 'right' },
  { id: 'free-photographs', label: 'PHOTOGRAPHS', entry: 'photos', details: ['Photography', 'Photo albums / memories'], x: 49, y: 31 },
];
